...
namespace websiteproject11.Jobseeker
{
    public partial class ChangePassword_JobSeeker : System.Web.UI.Page
    {
        ...
        protected void btncp_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("update tbljobseeker set js_password='" + txtnewpassword.Text + "' where js_id='" + Session["JSID"] + "' and js_password='" + txtcurrentpassword.Text + "'", con);
