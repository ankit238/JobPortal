...
{
    public partial class ChangePassword_Jobrecruiter : System.Web.UI.Page
    {
        ...
        protected void btncp_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("update tbljobRecruiter set jr_password='" + txtnewpassword.Text + "' where jr_id='" + Session["JRID"] + "' and jr_password='" + txtcurrentpassword.Text + "'", con);
